...
| 0023 | [Commit-and-push perceived freeze](0023-MADR-commit-and-push-perceived-freeze.md) | `accepted` (amended) | [plan](0023-PLAN-commit-and-push-perceived-freeze.md) | `executed`; **live-app measurement open** |
| 0024 | [SSH / remote-repo engine debug audit](0024-MADR-ssh-and-remote-repo-engine-debug-audit.md) | `accepted` (amended A1.1, A2.1, L2) | [plan](0024-PLAN-ssh-and-remote-repo-engine-debug-audit.md) | `complete` for phases 0–7; **M2 unconfirmed (live host)**, **Phase 8 (P2) not executed** |
