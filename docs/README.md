...
| 0028 | [Ceiling refusal and teardown residue](0028-MADR-ceiling-refusal-and-teardown-residue.md) | `proposed` | [plan](0028-PLAN-ceiling-refusal-and-teardown-residue.md) | `proposed`; closes 0026's **H2** (a ceiling refusal is indistinguishable from a permanent host limitation, so a third watched repo polls at 48 processes/min indefinitely) and **H3** (teardown residue — measure first, no remedy planned). 5 phases, awaiting approval |
