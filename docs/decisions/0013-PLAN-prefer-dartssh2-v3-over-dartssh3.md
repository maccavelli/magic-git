...
1. `docs/decisions/0056-PLAN-architecture-and-feature-parity.md` §0.1: change any "dartssh2 2.21.1 / 2.22.5"
...
2. `docs/decisions/0013-MADR-prefer-dartssh2-v3-over-dartssh3.md`: already points
   at this file (applied when the plan was first written). Verify the
   link is still present; do not rewrite the decision.
3. `docs/decisions/0012-PLAN-adopt-dartssh2-v3.md`: already has the "do not execute"
