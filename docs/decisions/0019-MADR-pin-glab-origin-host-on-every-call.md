...
([docs/decisions/0056-PLAN-architecture-and-feature-parity.md](0056-PLAN-architecture-and-feature-parity.md) §4.1 / §4.3). That
...
* **Do not put tokens in argv or the export prelude.** Stdin login +
  ...
  ([ARCHITECTURE_PLAN.md](0056-PLAN-architecture-and-feature-parity.md) §4.3). Host *names* are
...
* [ARCHITECTURE_PLAN.md](0056-PLAN-architecture-and-feature-parity.md) §4 — glab as the GitLab
