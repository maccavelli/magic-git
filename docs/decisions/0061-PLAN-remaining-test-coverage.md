...
status: "partial"
date: 2026-08-15
verified: 2026-09-19  # 0054-PLAN Phase 2: test-file existence only (see the note below)
former-path: "docs/TEST_COVERAGE_PLAN.md"
---

# Remaining Test Coverage — Implementation Plan

> **Verified 2026-09-19** (0054-PLAN-docs-link-checker-and-standard-layout-migration.md, Phase 2), **by test-file existence only**: 12 of the 14 test files named in this plan's phase headings exist; `test/workspace_registration_test.dart` and `test/local_repo_form_test.dart` do not. Whether each existing file covers what its phase asked for was not checked.
