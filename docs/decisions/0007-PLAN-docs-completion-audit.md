...
Edit `docs/decisions/0004-MADR-ui-ux-deep-debug-audit.md:409-410` (the
...
`docs/decisions/0004-PLAN-ui-ux-deep-debug-audit.md:981` (Checkpoint K) to remove
...
In `docs/decisions/0004-PLAN-ui-ux-deep-debug-audit.md`, tick the Phase 2–9 exit-criteria
...
**0.3 — Correct `docs/decisions/0055-PLAN-post-review-action-plan.md`.** Four edits:
...
**0.4 — Scrub residual env-token framing from `docs/decisions/0056-PLAN-architecture-and-feature-parity.md`.**
