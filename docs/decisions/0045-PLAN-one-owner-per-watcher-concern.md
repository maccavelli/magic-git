...
* `docs/decisions/0045-MADR-one-owner-per-watcher-concern.md`
* `docs/decisions/0045-PLAN-one-owner-per-watcher-concern.md`
* `docs/README.md`
...
`docs/decisions/0041-PLAN-the-watcher-the-client-cannot-kill.md`,
`docs/decisions/0043-PLAN-a-watcher-refused-by-its-own-session.md` and
`docs/decisions/0044-PLAN-the-watcher-follows-the-active-tab.md`.
...
`docs/decisions/0043-PLAN-a-watcher-refused-by-its-own-session.md` and
`docs/decisions/0044-PLAN-the-watcher-follows-the-active-tab.md`. The standalone plan is a separate
