...
2. Add `docs/reports/0005-REPORT-ux-baseline-task-centered-adaptive-repository-workspace.md`
...
| File | Change |
| --- | --- |
| `docs/decisions/0005-MADR-task-centered-adaptive-repository-workspace.md` | Status/date only after acceptance |
| `docs/reports/0005-REPORT-ux-baseline-task-centered-adaptive-repository-workspace.md` | New measured baseline artifact |
...
| `docs/reports/0005-REPORT-ux-baseline-task-centered-adaptive-repository-workspace.md` | Measured follow-up and comparison |
