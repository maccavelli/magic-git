...
* **Phase 3 (2026-09-21, execution).**
  * 3.1: exit 1, `Error when reading 'lib/core/forge/ci_log_text.dart': No such file or directory`
    and `Method not found: 'sanitizeGhJobLog'`.
  * 3.2: apply `exit=0`.
