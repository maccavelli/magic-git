...
- `docs/decisions/0001-MADR-native-git-libgit2.md` — CLI/executor architecture retained
- `docs/decisions/0055-PLAN-post-review-action-plan.md` — historical note on Approve/Merge double-submit safety
