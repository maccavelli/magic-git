...
1. **Retire entry 1**, `0032` `sheet: active connection not resolved for history`: delete it
   ...
   `dc78436` after `docs/decisions/0038-PLAN-workspace-entry-points-debugging-pass.md` showed it always
...
* Annotate the catalogue results in `docs/decisions/0032-PLAN-recent-and-searchable-forge-namespaces.md` and
  `docs/decisions/0036-PLAN-choosing-a-create-destination-while-connected.md` — annotations, not rewrites —
