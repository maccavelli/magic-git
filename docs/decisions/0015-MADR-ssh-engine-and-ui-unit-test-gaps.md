...
[TEST_COVERAGE_PLAN.md](0061-PLAN-remaining-test-coverage.md) is **stale as a count
...
* SSH engine product work: [0014-MADR-ssh-engine-next-wave-hardening.md](0014-MADR-ssh-engine-next-wave-hardening.md),
  ...
  [ARCHITECTURE_PLAN.md](0056-PLAN-architecture-and-feature-parity.md) §0.1.
* Prior UI audits: [0004](0004-MADR-ui-ux-deep-debug-audit.md),
  [0009](0009-MADR-ui-ux-debug-pass-backlog.md).
* Historical coverage list (stale counts): [TEST_COVERAGE_PLAN.md](0061-PLAN-remaining-test-coverage.md).
