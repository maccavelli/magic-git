...
* Cross-check `docs/decisions/0056-PLAN-architecture-and-feature-parity.md` §0.1 (sync client exists so pack
...
* [ARCHITECTURE_PLAN.md](0056-PLAN-architecture-and-feature-parity.md) §0.1 — transport truth
