...
* Cross-check `docs/decisions/0056-PLAN-architecture-and-feature-parity.md` §0.1 (authoritative transport
...
* Transport truth: [ARCHITECTURE_PLAN.md §0.1](0056-PLAN-architecture-and-feature-parity.md)
