...
* `docs/reports/0058-REPORT-window-sizing-assessment.md` audited every sheet in the app and marked
...
* `docs/reports/0058-REPORT-window-sizing-assessment.md` — the sheet-sizing audit that rates the
