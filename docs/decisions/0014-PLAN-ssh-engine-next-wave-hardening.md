...
* **Edit** `docs/decisions/0056-PLAN-architecture-and-feature-parity.md` §0.1 (may wait for Phase 9 if the
...
* **Edit** `docs/decisions/0056-PLAN-architecture-and-feature-parity.md` §0.1
* **Edit** `docs/decisions/0014-MADR-ssh-engine-next-wave-hardening.md` — "Implementation
