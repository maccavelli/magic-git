...
multipliers, and several panel bugs (see `docs/decisions/0055-PLAN-post-review-action-plan.md`,
`docs/reports/0057-REPORT-file-view-engine-assessment.md`, `docs/reports/0059-REPORT-memory-and-performance-audit.md`,
`docs/reports/0058-REPORT-window-sizing-assessment.md`). Those documents are partially historical:
...
* `drop_registry.dart` `DropZoneId.history` → `const []`. Rail still presents
  ...
  while A–D are shipped (`docs/reports/0060-REPORT-drag-and-drop-engine-feasibility.md`). Remaining product
...
* `docs/reports/0060-REPORT-drag-and-drop-engine-feasibility.md` header outdated; `ACTION_PLAN.md` deferred
...
* `docs/decisions/0055-PLAN-post-review-action-plan.md` — prior multi-cycle review (mostly done; some deferred).
* `docs/reports/0057-REPORT-file-view-engine-assessment.md` — viewer residuals (L7).
* `docs/reports/0058-REPORT-window-sizing-assessment.md` — min/default sizes largely implemented.
* `docs/reports/0059-REPORT-memory-and-performance-audit.md` — Tier 1–2 memory fixes done.
* `docs/reports/0060-REPORT-drag-and-drop-engine-feasibility.md` — A–E shipped, including the in-panel E1
  disambiguation menu on commit rows (`history_view.dart:2201-2260`).
* `docs/decisions/0001-MADR-native-git-libgit2.md` — GPG/signing architecture context (H7).
* `docs/decisions/0002-MADR-forge-change-request-merge-and-models.md` — forge merge depth;
  conversation comments landed (M8); inline review threads remain out of scope.
* `docs/decisions/0003-MADR-base-relative-branches-workspace.md` — branches workspace;
