...
- Date: 2026-08-05
- MADR: `docs/decisions/0003-MADR-base-relative-branches-workspace.md` (Option C)
...
Status: **implementation complete 2026-08-05; awaiting maintainer review.**
Automated coverage includes capability probe, clean/conflict/unrelated/
malformed/exit>1 merge-tree paths, concurrency gate, OID rekey, conflict scan
unknown≠clean, and `@Tags(['integration'])` temp-repo proofs that HEAD/index/
worktree stay unchanged after preview.
...
- `docs/decisions/0003-MADR-base-relative-branches-workspace.md` (authoritative product
  decision and confirmation criteria; this plan supplies its executable
  provider, bulk-delete, and phase contracts)
- `docs/decisions/0002-MADR-forge-change-request-merge-and-models.md`
- `docs/decisions/0002-PLAN-forge-change-request-merge-and-models.md`
