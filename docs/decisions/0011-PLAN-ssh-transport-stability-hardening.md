...
| `docs/decisions/0056-PLAN-architecture-and-feature-parity.md` | §0.1: busy-aware monitoring description + remote-host recommendations subsection |
...
1. `docs/decisions/0056-PLAN-architecture-and-feature-parity.md` §0.1: document busy-aware monitoring (replace
...
- [ ] `docs/decisions/0056-PLAN-architecture-and-feature-parity.md` §0.1: busy-aware monitoring + drop telemetry description
- [ ] `docs/decisions/0056-PLAN-architecture-and-feature-parity.md` §0.1: remote-host recommendations subsection
