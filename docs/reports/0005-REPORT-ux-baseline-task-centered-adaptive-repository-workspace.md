...
date: 2026-08-13
verified: 2026-08-20
former-path: "docs/0005-UX-BASELINE-task-centered-adaptive-repository-workspace.md"
---

# UX baseline for the task-centered adaptive repository workspace

Associated decision:
[0005-MADR-task-centered-adaptive-repository-workspace.md](../decisions/0005-MADR-task-centered-adaptive-repository-workspace.md)

Associated implementation plan:
[0005-PLAN-task-centered-adaptive-repository-workspace.md](../decisions/0005-PLAN-task-centered-adaptive-repository-workspace.md)
